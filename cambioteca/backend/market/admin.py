...
class LibroAdmin(admin.ModelAdmin):
    list_display = ("id_libro", "titulo", "autor", "genero", "estado", "id_usuario", "fecha_compra")
    search_fields = ("titulo", "autor", "isbn", "editorial", "genero")
    list_filter = ("genero", "estado", "tipo_tapa", "editorial", "anio_publicacion")
    date_hierarchy = "fecha_compra"
    ordering = ("-fecha_compra", "titulo")
    list_per_page = 50
...
class ImagenLibroAdmin(admin.ModelAdmin):
    list_display = ("id_imagen", "id_libro", "descripcion", "url_imagen")
...
class IntercambioAdmin(admin.ModelAdmin):
    ...
    list_per_page = 50
    raw_id_fields = ("id_usuario_solicitante", "id_usuario_ofreciente", "id_libro_solicitado", "id_libro_ofrecido")
    list_select_related = ("id_usuario_solicitante", "id_usuario_ofreciente", "id_libro_solicitado", "id_libro_ofrecido")
...
class ClasificacionAdmin(admin.ModelAdmin):
    ...
    search_fields = ("id_usuario_calificador__nombre_usuario", "id_usuario_calificado__nombre_usuario", "comentario")
